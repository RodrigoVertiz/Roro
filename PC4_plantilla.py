...
st.markdown("<h1 style='text-align: center;'>REAL HASTA LA MUERTE CON PYTHON 😈</h1>", unsafe_allow_html=True)
...
col1.image("si_soy_este.jpg", caption='Rodrigo Vertiz', width=300)
...
texto = """
Soy Rodrigo Vertiz Ríos, tengo 21 años, pero parezco alguien de 30 años, y actualmente estoy cursando mi sexto ciclo de la carrera de Periodismo en la PUCP. Soy hincha del club Alianza Lima desde que tengo memoria. Ser hincha acérrimo de este club fue una de las razones por las que emepece a estudiar mi carrera, pues en un futuro tengo la ilusión de poder trabajar con ellos para poder crear contenido futbolístico relacionado al club de mis amores. Por otro lado, mis hobbies son jugar fútbol, y ver películas y series. Mis series favoritas son The Office y Malcolm el de en medio, mientras que mis peliculas favoritas son todas las de transformers menos la 5.
"""
...
texto_2 = """
Nunca en mi vida había pensado que llevaría algún curso relacionado a la prograación, pero eso cambio este año cuando la malla curricular de la carrera cambió. Personalmente, en un principio le tenía mucho respeto a la programación, pues lo veía como algo realmente complejo por realizar, pero conforme fue pasando el ciclo me di cuenta que programar a través de Python no era algo con complicado como creía, pues si aprendes correctamente para qué sirve cada código no tendrás ningún problema en conseguir lo que el curso te pide. Estoy seguro que en un futuro todo lo aprendido en el curso me servirá para futuros trabajos.  
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Gráficos creados en el curso. </h1>", unsafe_allow_html=True)
...
graficos = ['Mapa de mis peliculas favoritas', 'Gráfico de promedios de goles', 'Gráfico promedio de amarillas']
...
if grafico_seleccionado == 'Mapa de mis peliculas favoritas':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>En este gráfico se muestra cuáles son las locaciones donde se rodaron mis peliculas favoritas.</div>", unsafe_allow_html=True)
    sidebar.image("roro_1.png", caption='Mapa de mis peliculas favoritas', width=500)
    pass
elif grafico_seleccionado == 'Gráfico de promedios de goles':
    sidebar.markdown("<div style='text-align: justify'>En este gráfico se muestra el promedio de goles de un italiano de año 2022.</div>", unsafe_allow_html=True)
    sidebar.image("roro_2.png", caption='Gráfico de promedios de goles', width=500)
    pass
elif grafico_seleccionado == 'Gráfico promedio de amarillas':
    sidebar.markdown("<div style='text-align: justify'>La cantidad de amarillas de los equipos de la serie A en el 2022.</div>", unsafe_allow_html=True)
    sidebar.image("roro_3.png", caption='Gráfico promedio de amarillas', width=500)
    pass
